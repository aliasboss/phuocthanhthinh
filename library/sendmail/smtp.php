...
function SendMail($frommail,$tomail,$subject,$message,$fromfullname="Sindre Design")
{
      ...
      $smtp_host ='mail.hoikimhoancamau.com';//Dia chi mail server
      $admin_email = 'admin@hoikimhoancamau.com';//User duoc khai bao tren mail server
      $smtp_username = 'admin@hoikimhoancamau.com';//User duoc khai bao tren mail server
      $smtp_password = 'khanh@alias';//Pass cua email nay
